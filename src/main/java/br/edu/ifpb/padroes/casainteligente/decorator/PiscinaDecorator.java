...
public class PiscinaDecorator extends CenarioDecorator{

	public PiscinaDecorator(CenarioComponente cenario) {
		super(cenario);
	...
	public String ligarPiscina() {
		// TODO Auto-generated method stub
		return "Piscina ligada" + cenario.ligarPiscina();
	}

	@Override
	public String desligarPiscina() {
		// TODO Auto-generated method stub
		return "Piscina desligada" + cenario.desligarPiscina();
	}
