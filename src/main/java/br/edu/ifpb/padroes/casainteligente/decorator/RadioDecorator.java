...
public class RadioDecorator extends CenarioDecorator{

	public RadioDecorator(CenarioComponente cenario) {
		super(cenario);
	...
	public String ligarRadio() {
		// TODO Auto-generated method stub
		return "Radio ligado" + cenario.ligarRadio();
	}

	@Override
	public String desligarRadio() {
		// TODO Auto-generated method stub
		return "Radio desligado" + cenario.desligarRadio();
	}
