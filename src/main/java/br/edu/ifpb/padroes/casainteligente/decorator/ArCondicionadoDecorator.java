...
public class ArCondicionadoDecorator extends CenarioDecorator{

	public ArCondicionadoDecorator(CenarioComponente cenario) {
		super(cenario);
	...
	public String ligarArCondicionado() {
		// TODO Auto-generated method stub
		return "Ar condicionado ligado" + cenario.ligarArCondicionado();
	}

	@Override
	public String desligarArCondicionado() {
		// TODO Auto-generated method stub
		return "Ar condicionado desligado" + cenario.desligarArCondicionado();
	}
